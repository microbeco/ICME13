...
\VariableTok{assembly}\OperatorTok{=}\StringTok{"/SERVER/mg\_data/mg/Assembly\_metaflye/assembly.fasta"}
...
\ControlFlowTok{done} \OperatorTok{\textless{}}\NormalTok{ all\_names.txt}
\end{Highlighting}
\end{Shaded}
